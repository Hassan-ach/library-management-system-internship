    ...
    // <<<<<<<<<<<<<<<<<<<< search user    
        ...
        public function post_search(Request $request){
            try{
                ...
                ->orWhereHas('has_request',function($query) use ($search) {
                ...
                return  compact($user,$search);

            }catch(\Exception $e){
                return view('admin.users')->with('error', 'Unable to load users at the moment. Please try again later.');
            }   
        }
